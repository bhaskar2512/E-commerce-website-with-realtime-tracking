...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/admin/orders', {
    headers: {
...
function updatecart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/update-cart', cake).then(function (res) {
...
function updateStatus(order) {
  var x = true;
  var allStatus = document.querySelectorAll('.status-line');

  var _iterator = _createForOfIteratorHelper(allStatus),
      _step;
  ...
  var _iterator2 = _createForOfIteratorHelper(allStatus),
      _step2;
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (x) {
        _status.classList.add('step-completed');
      }

      if (_status.dataset.status === order.status) {
        x = false;
        time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:mm A');

        _status.appendChild(time);

        if (_status.nextElementSibling) {
          _status.nextElementSibling.classList.add('current');
        }
      }
    }
  } catch (err) {
...
__webpack_require__(/*! /Users/bhaskartripathi/Desktop/cakes/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/bhaskartripathi/Desktop/cakes/resources/scss/app.scss */"./resources/scss/app.scss");
